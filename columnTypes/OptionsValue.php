...
/**
 * Column type for getting value of options field
 */
class OptionsValue extends \RockFinder3\Column {
  public function applyTo($finder) {
    ...
    $finder->query->select("GROUP_CONCAT(`_options_{$this->alias}`.`value`) AS `{$this->alias}`");
  }
}
